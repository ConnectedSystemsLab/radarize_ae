...
class ECAResNet18(nn.Module):
    def __init__(self, n_channels, n_outputs):
        ...
        self.conv1 = nn.Conv2d(n_channels, 64, kernel_size=(7, 7), stride=(2, 2),
                                        padding=(3, 3), bias=False)                  # conv1
...
class ResNet34(nn.Module):
    def __init__(self, n_channels, n_outputs):
        ...
        self.resnet34.conv1 = nn.Conv2d(n_channels, 64, kernel_size=(7, 7), stride=(2, 2),
...
class ResNet18(nn.Module):
    ...
    def __init__(self, n_channels, n_outputs):
        ...
        self.resnet18.conv1 = nn.Conv2d(n_channels, 64, kernel_size=(7, 7), stride=(2, 2), 
                                        padding=(3, 3), bias=False)
...
class ResNet50(nn.Module):
    ...
    def __init__(self, n_channels, n_outputs):
        ...
        self.resnet50.conv1 = nn.Conv2d(n_channels, 64, kernel_size=(7, 7), stride=(2, 2), 
                                        padding=(3, 3), bias=False)
...
class ResNet18Nano(nn.Module):
    ...
    def __init__(self, n_channels, n_outputs):
        ...
        resnet18.conv1 = nn.Conv2d(n_channels, 64, kernel_size=(7, 7), stride=(2, 2), 
                                   padding=(3, 3), bias=False)
