...
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.linear_search_window = 1e-2
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 1e3
...
POSE_GRAPH.constraint_builder.max_constraint_distance = 0
